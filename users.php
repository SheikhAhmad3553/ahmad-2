                            ...
                            <div class="block">
                                <div class="block-title">
                                    <div class="block-left">
                                        ...
                                        <div class="mt-10">
                                            <a class="btn btn-primary btn-slim" href="users.php?role=all">All (30)</a>
                                            <a class="btn btn-primary btn-slim" href="users.php?role=host">Hosts (5)</a>
                                            <a class="btn btn-primary btn-slim" href="users.php?role=guest">Guests (25)</a>
